...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="screen-section section container"><div className="screen-image"><ResponsiveImage src="/images/big-screen-match.jpg" alt="A football match shown on the big screen at Sensasia in Ragama" className="full-media" imageClassName="card-image screen-match-image" sizes="(max-width:760px) 100vw, 55vw"/><div className="screen-image-shade"/></div><div><p className="eyebrow"><FaTv/> Big-screen entertainment</p><h2>Big games. Big screens. Full bar.</h2><p>Catch major sporting moments and entertainment with the people who make them better. Settle in with food for the table and drinks from the bar.</p><div className="night-steps"><span><b>01</b>Dinner</span><span><b>02</b>Cocktails</span><span><b>03</b>The match or music</span><span><b>04</b>One more round</span></div></div></section>
